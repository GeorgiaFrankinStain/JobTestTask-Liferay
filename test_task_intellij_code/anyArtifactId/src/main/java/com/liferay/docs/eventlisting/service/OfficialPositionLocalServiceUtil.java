...
/**
 * Provides the local service utility for OfficialPosition. This utility wraps
 * {@link com.liferay.docs.eventlisting.service.impl.OfficialPositionLocalServiceImpl} and is the
 ...
 * @generated
 */
public class OfficialPositionLocalServiceUtil {
    private static OfficialPositionLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.liferay.docs.eventlisting.service.impl.OfficialPositionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.liferay.docs.eventlisting.model.OfficialPosition addOfficialPosition(
        ...
        return getService().addOfficialPosition(officialPosition);
    }
    ...
    */
    public static com.liferay.docs.eventlisting.model.OfficialPosition createOfficialPosition(
        long officialPositionId) {
        return getService().createOfficialPosition(officialPositionId);
    }
    ...
    */
    public static com.liferay.docs.eventlisting.model.OfficialPosition deleteOfficialPosition(
        ...
        return getService().deleteOfficialPosition(officialPositionId);
    }
    ...
    */
    public static com.liferay.docs.eventlisting.model.OfficialPosition deleteOfficialPosition(
        com.liferay.docs.eventlisting.model.OfficialPosition officialPosition)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteOfficialPosition(officialPosition);
    }
    ...
    */
    ...
    public static com.liferay.docs.eventlisting.model.OfficialPosition fetchOfficialPosition(
        long officialPositionId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchOfficialPosition(officialPositionId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.liferay.docs.eventlisting.model.OfficialPosition getOfficialPosition(
        long officialPositionId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getOfficialPosition(officialPositionId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.liferay.docs.eventlisting.model.OfficialPosition> getOfficialPositions(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getOfficialPositions(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getOfficialPositionsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getOfficialPositionsCount();
    }
    ...
    */
    public static com.liferay.docs.eventlisting.model.OfficialPosition updateOfficialPosition(
        com.liferay.docs.eventlisting.model.OfficialPosition officialPosition)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateOfficialPosition(officialPosition);
    }
    ...
    */
    ...
    public static com.liferay.docs.eventlisting.model.OfficialPosition findById(
        long OfficialPositionId)
        throws com.liferay.docs.eventlisting.NoSuchOfficialPositionException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().findById(OfficialPositionId);
    }
    ...
    public static OfficialPositionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    OfficialPositionLocalService.class.getName());

            if (invokableLocalService instanceof OfficialPositionLocalService) {
                _service = (OfficialPositionLocalService) invokableLocalService;
            } else {
                _service = new OfficialPositionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(OfficialPositionLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(OfficialPositionLocalService service) {
    }
}
