...
public class BankWrapper implements Bank, ModelWrapper<Bank> {
    ...
    */
    ...
    @Override
    public int compareTo(com.liferay.docs.eventlisting.model.Bank bank) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.liferay.docs.eventlisting.model.Bank> toCacheModel() {
        return _bank.toCacheModel();
    }

    @Override
    public com.liferay.docs.eventlisting.model.Bank toEscapedModel() {
        return new BankWrapper(_bank.toEscapedModel());
    }

    @Override
    public com.liferay.docs.eventlisting.model.Bank toUnescapedModel() {
