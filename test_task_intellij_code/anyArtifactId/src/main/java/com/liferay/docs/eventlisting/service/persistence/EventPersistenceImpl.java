...
import com.liferay.docs.eventlisting.NoSuchEventException;
import com.liferay.docs.eventlisting.model.Event;
import com.liferay.docs.eventlisting.model.impl.EventImpl;
import com.liferay.docs.eventlisting.model.impl.EventModelImpl;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
    ...
    @Override
    public Event updateImpl(com.liferay.docs.eventlisting.model.Event event)
        throws SystemException {
        event = toUnwrappedModel(event);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.liferay.docs.eventlisting.model.Event")));
