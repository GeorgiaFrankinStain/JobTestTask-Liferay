...
/**
 * Provides the local service interface for OfficialPosition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Joe Bloggs
 * @see OfficialPositionLocalServiceUtil
...
public interface OfficialPositionLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link OfficialPositionLocalServiceUtil} to access the official position local service. Add custom service methods to {@link com.liferay.docs.eventlisting.service.impl.OfficialPositionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
